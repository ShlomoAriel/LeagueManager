    ...
    function() {
      ...
      return {
        ...
        template: function(elem, attrs) {
          ...
          var tmpl = "<div class=\"datetimepicker-wrapper col-md-3 date-custom\">" +
            ...
            "/>\n" +
            "</div>\n" +
            "<div class=\"datetimepicker-wrapper col-md-3\" ng-model=\"time\" ng-change=\"time_change()\" style=\"display:inline-block\">\n" +
            "<timepicker " + [
              ["hourStep"],
              ["minuteStep"],
              ["showMeridian"],
